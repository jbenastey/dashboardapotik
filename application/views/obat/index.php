...
<div class="card">
              ...
              <div class="card-body">
                <table class="table table-striped table-valign-middle table-responsive"id="example1">
                  <thead>
                  <tr>
                    <th>kode_obat</th>
                    <th>jenis_obat</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url('obat/edit/').$value ['kode_obat']?>" class="btn btn-success"><i class="fa fa-pencil"></i></a>
                        <a href="<?php echo base_url('obat/delete/').$value ['kode_obat']?>" class="btn btn-danger" onclick="return confirm('apakah yakin menghapus data ini')"><i class="fa fa-trash"></i></a>
                      </td>
